...
public class Ventana_Busqueda {
    ...
    public Ventana_Busqueda() {
        ...
        kotlinButton.addActionListener(e -> {
            try {
                ...
                generar_MensajesError(nul.getMessage());
            }
        });
    ...
    private void generar_MensajesError(String mensaje) {
        JOptionPane.showMessageDialog(null, "No se encontraron los datos en la lista: " + mensaje, "ERROR", JOptionPane.ERROR_MESSAGE);
    }
